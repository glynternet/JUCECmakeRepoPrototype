...
public:
    explicit LoudnessAnalyserSettings(LoudnessAnalyser &loudnessAnalyser, const float initialProcessRateHz,
            ...
            frequencyProcessingBand("Frequency Band", 0.0f, 1.0f,
                                    initialProcessingBandLow, initialProcessingBandHigh, 0.5f,
            ...
            rangeIn("Range In", -0.1f, 1.1f, 0.1f, 0.8f, 0.3f,
            ...
            decayLength("Decay Length", TailOff::minExponent, TailOff::maxExponent, initialDecayExponent,
            ...
            movingAverage("Window Size", 1.f, 7.f, 1.f, movingAverageInitialWindow, 1.f,
                          [&loudnessAnalyser](const double value) {
                              loudnessAnalyser.movingAverage.setPeriod((int) value);
                          }),

            processRateSlider("Process rate", 5.f, 70.f, initialProcessRateHz,
...
private:
    ...
    LabelledSlider frequencyProcessingBand;
    LabelledSlider rangeIn;
    LabelledSlider decayLength;
    LabelledSlider movingAverage;
    LabelledSlider processRateSlider;
};
