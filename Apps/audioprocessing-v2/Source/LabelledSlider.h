...
public:
    ...
    LabelledSlider(const String &labelText, const float rangeMin, const float rangeMax,
    ...
    LabelledSlider::LabelledSlider(const String &labelText, const float rangeMin, const float rangeMax,
                                   const float value,
                                   const std::function<void(const double value)> &onValueChange);
    LabelledSlider(const String &labelText, const float rangeMin, const float rangeMax, const float rangeInterval,
                   const float value, const float setSkewFactorFromMidPoint,
                   const std::function<void(const double value)> &onValueChange);
    LabelledSlider(const String &labelText, const float rangeMin, const float rangeMax,
