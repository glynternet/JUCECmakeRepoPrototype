...
#ifndef JUCECMAKEREPO_LOUDNESSANALYSER_H
#define JUCECMAKEREPO_LOUDNESSANALYSER_H
...
class LoudnessAnalyser : juce::Timer {
public:
    explicit LoudnessAnalyser(std::function<void(float)> onLoudnessResult, float processRate, float processingBandIndexLow,
...
#endif //JUCECMAKEREPO_LOUDNESSANALYSER_H
